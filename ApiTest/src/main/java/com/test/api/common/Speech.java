...
public class Speech {
	...
	private static final String SECRET = "6b2f776540084f73be7712053cef769c";
    // Clova Speech invoke URL
	private static final String INVOKE_URL = "https://clovaspeech-gw.ncloud.com/external/v1/3030/66a059814219e76c8bc7871c9e2758064b68a5582468c6e4460646f3509ed3e3";
	...
	public String speechTest(String path) {
		final Speech clovaSpeechClient = new Speech();
		NestRequestEntity requestEntity = new NestRequestEntity();
		final String result =
			clovaSpeechClient.upload(new File(path+"\\video1.mp4"), requestEntity);
